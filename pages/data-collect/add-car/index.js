...
export default {
  ...
  methods: {
    ...
    handleCalendarChange(date) {
      this.form.purchase_date = Object.assign({}, this.form.purchase_date, pick(date, ['result', 'year', 'month', 'day']))
    },
    handleGoSelectBrand() {
    ...
    handleChooseLocation() {
      uni.chooseLocation({
        success: loc => {
          this.form.purchase_loc = Object.assign({}, this.form.purchase_loc, pick(loc, ['name', 'address', 'latitude', 'longitude']))
